...
import VariantCostCentersInput from "./VariantCostCentersInput";
...
const VariantDetailsCard: React.FC<VariantDetailsCardProps> = ({
  formType,
  model,
  setModel,
  suppliers,
  ...
  return (
    <div className="card card-body">
      <h5 className="mb-4">{handleTranslate("VariantDetails")}</h5>
      ...
      <div className="row mb-3">
        <div className="col col-md-12">
          <VariantCostCentersInput
            formType={formType}
            variantCostCenters={model.costCenters ?? []}
            handleUpdate={(items) => {
              setModel((prevModel) =>
